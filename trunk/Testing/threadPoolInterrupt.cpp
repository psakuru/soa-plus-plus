...
protected:
    void doService()
    {
    	...
    	threadIDToStringConverter >> threadID;
        cout << "TID:" << threadID  << " chiamata ricevuta" << endl << endl;
        /* <ricezione e store> */
...
{
    try{
    RegistrableSkeletonThreadPool<RegistrablePoolableCallableSkeletonWrapper<ParticularRegistrablePoolableCyclicCallableSkeleton> >* r = new RegistrableSkeletonThreadPool< RegistrablePoolableCallableSkeletonWrapper<ParticularRegistrablePoolableCyclicCallableSkeleton> >(3, "127.0.0.1", 3000, SOMAXCONN);
    char a = 'a';
